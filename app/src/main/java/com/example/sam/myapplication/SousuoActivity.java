...
import com.example.sam.myapplication.ui.sou.MyListView;
import com.example.sam.myapplication.ui.sou.RecordSQLiteOpenHelper;
...
public class SousuoActivity extends AppCompatActivity {
    ...
    private void initView() {
        ...
        Drawable drawable = getResources().getDrawable(R.drawable.suo);
